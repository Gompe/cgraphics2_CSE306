...
void save_frame(const std::vector<Polygon> &_cells, std::string filename, int frameid) {
    const std::vector<Polygon> &cells = _cells;
    // Default 1000, 1000
    int W = 1000, H = 1000;
    ...
    for (int i = 0; i < cells.size(); i++) {
        ...
        // CHANGED THE TWO LINES BELOW
        // Before it was std::max(...)
